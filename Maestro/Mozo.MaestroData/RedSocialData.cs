...
{
    Task<int> InsertAsync(EntidadRedSocialModel c, IDbTransaction? tran = null);
    Task UpdateAsync(EntidadRedSocialModel c);
    Task DeleteByIdAsync(PersonaRedSocialFilterDto c);
    Task<EntidadRedSocialModel?> SelByIdAsync(PersonaRedSocialFilterDto c);
    Task<IEnumerable<EntidadRedSocialModel>> SelAllAsync(PersonaRedSocialFilterDto c);
}
public partial class RedSocialData : IRedSocialData
{
    ...
    public async Task<int> InsertAsync(EntidadRedSocialModel c, IDbTransaction? tran = null)
    {

        DynamicParameters pr = new();
        pr.Add2("CoEmpresa", c.FlEmpresaNotKey == 1 ? c.CoEmpresa : _user.CoEmpresaRequired, DbType.Int32);
    ...
    public async Task UpdateAsync(EntidadRedSocialModel c)
    {
        DynamicParameters pr = new();
        pr.Add2("CoEmpresa", c.FlEmpresaNotKey == 1 ? c.CoEmpresa : _user.CoEmpresaRequired, DbType.Int32);
        pr.Add2("CoRedSocial", c.CoPersonaRedSocial, DbType.Int32);
        pr.Add2("CoTipoUrl", c.CoTipoUrl, DbType.Int32);
        pr.Add2("CoEtiqueta", c.CoEtiqueta, DbType.Int32);
        pr.Add2("NoRedSocial", c.NoRedSocial, DbType.String);
        pr.Add2("FlWhatsapp", c.FlWhatsapp, DbType.Int32);
    ...
    public async Task DeleteByIdAsync(PersonaRedSocialFilterDto c)
    {
        DynamicParameters pr = new();
        pr.Add2("CoEmpresa", c.FlEmpresaNotKey == 1 ? c.CoEmpresa : _user.CoEmpresaRequired, DbType.Int32);
        pr.Add2("CoPersonaRedSocial", c.CoPersonaRedSocial, DbType.Int32);
    ...
    public async Task<IEnumerable<EntidadRedSocialModel>> SelAllAsync(PersonaRedSocialFilterDto c)
    {
        DynamicParameters pr = new();
        pr.Add2("CoEmpresa", c.FlEmpresaNotKey == 1 ? c.CoEmpresa : _user.CoEmpresaRequired, DbType.Int32);
        pr.Add2("FlPersona", c.FlPersona, DbType.Int32);
        ...
        return await _connection.QueryAsync<EntidadRedSocialModel>(sql, pr);
    }
    public async Task<EntidadRedSocialModel?> SelByIdAsync(PersonaRedSocialFilterDto c)
    {
        DynamicParameters pr = new();
        pr.Add2("CoEmpresa", c.FlEmpresaNotKey == 1 ? c.CoEmpresa : _user.CoEmpresaRequired, DbType.Int32);
        pr.Add2("CoRedSocial", c.CoPersonaRedSocial, DbType.Int32);
        ...
        return await _connection.QueryFirstOrDefaultAsync<EntidadRedSocialModel>(sql, pr);
    }
