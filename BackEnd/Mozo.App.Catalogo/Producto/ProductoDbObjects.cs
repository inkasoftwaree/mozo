...
public static class ProductoDbObjects
{
    private const string Schema = "catalogo";
    private static readonly DbObjectFactory.StandardDbObjects _std = DbObjectFactory.Standard(Schema, "producto");
    ...
    public static readonly DbObject SelAllCount =
        new(Schema, "fn_producto_sel_all_count", DbExecutionType.Select, DbReturnType.Scalar);

    public static readonly DbObject SelAllActive =
        new(Schema, "fn_producto_sel_all_active", DbExecutionType.Select, DbReturnType.List);
}
