...
public static class ProductoStockDbObjects
{
    private const string Schema = "catalogo";
    private static readonly DbObjectFactory.StandardDbObjects _std = DbObjectFactory.Standard(Schema, "productostock");
    ...
    public static readonly DbObject SelAllActive =
        new(Schema, "fn_productostock_sel_all_active", DbExecutionType.Select, DbReturnType.List);
}
