...
public static class ProductoPrecioDbObjects
{
    private const string Schema = "catalogo";
    private static readonly DbObjectFactory.StandardDbObjects _std = DbObjectFactory.Standard(Schema, "productoprecio");
    ...
    public static readonly DbObject SelAllActive =
        new(Schema, "fn_productoprecio_sel_all_active", DbExecutionType.Select, DbReturnType.List);
}
