...
public static class ProductoImpuestoDbObjects
{
    private const string Schema = "catalogo";
    private static readonly DbObjectFactory.StandardDbObjects _std = DbObjectFactory.Standard(Schema, "productoimpuesto");
    ...
    public static readonly DbObject SelAllActive =
        new(Schema, "fn_productoimpuesto_sel_all_active", DbExecutionType.Select, DbReturnType.List);
}
