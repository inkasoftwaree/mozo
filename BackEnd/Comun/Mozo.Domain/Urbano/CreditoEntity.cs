...
[Serializable]
public partial class CreditoEntity : BaseEntity
{
...
public partial class CreditoEntity
{
    // public EmpresaModel Empresa { get; set; }
    // public ProyectoModel Proyecto { get; set; }
    // public EtapaModel Etapa { get; set; }
    public BonoEntity? Bono { get; set; }
    public DocPagoEntity? DocSeparacion { get; set; }
    public DocPagoEntity? DocInicial { get; set; }
    public DocPagoEntity? DocBono { get; set; }
    public LoteEntity? Lote { get; set; }
    public EntidadEntity? Cliente { get; set; }
    public CreditoResumenEntity? CreditoResumen { get; set; }

    public EntidadEntity? Vendedor { get; set; }
    ...
    public List<CuotaEntity>? CuotaLst { get; set; }
