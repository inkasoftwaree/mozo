...
[Serializable]
public partial class SoporteEntity : BaseEntity
{
...
public partial class SoporteEntity
{
    #region Soporte

    public string? FeCreIni { get; set; }
    public string? FeCreFin { get; set; }
    public List<SeguimientoEntity>? SeguimientoLst { get; set; }
    ...
    public EntidadEntity? UsuAtendido { get; set; }
