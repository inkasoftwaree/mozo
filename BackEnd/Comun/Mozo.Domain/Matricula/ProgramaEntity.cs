...
public class ProgramaEntity : BaseEntity
{
    ...
    public List<ProgramaHorarioEntity>? HorarioList { get; set; }


    public List<ProgramaNotaEntity>? NotaList { get; set; }

    public List<ProgramaPensionEntity>? PensionList { get; set; }
}