...
public static class EnuCommon
{
    ...
    {
        public static readonly string Name = "Logistica";
        public static class Schema
        {
            ...
            public static readonly string Catalogo = "catalogo";

            public static readonly string Urbano = "urbano";


            public static readonly string Empresa = "empresa";

            public static readonly string Contabilidad = "contabilidad";
            public static readonly string Facturacion = "facturacion";
            public static readonly string FacturacionRpt = "facturacionrpt";

            public static readonly string Inventario = "inventario";
