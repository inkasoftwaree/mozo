...
public static partial class RedSocialEndPoints
{
    ...
    public static RouteGroupBuilder MapRedSocial(this RouteGroupBuilder g)
    {
        ...
        g.MapGet("/byid", SelByIdAsync)
            .WithResponses<EntidadRedSocialModel>(StatusCodes.Status200OK)
            .Produces(StatusCodes.Status404NotFound)
            .WithDescription("Obtener una Red Social");

        g.MapGet("/", SelAllAsync)
          .WithResponses<IEnumerable<EntidadRedSocialModel>>(StatusCodes.Status200OK)
...
public static partial class RedSocialEndPoints
{
    ...
    {
        IEnumerable<EntidadRedSocialModel> r = await IRedSocial.SelAllAsync(f);
    ...
    {
        EntidadRedSocialModel? i = await IRedSocial.SelByIdAsync(f);
        if (i == null)
